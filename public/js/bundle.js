...
var showAlerts = function showAlerts(type, mssg) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlerts)('error', _context.t0.response.data.message); //this will give the (postman) result
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlerts)('error', 'Error in logging out! Try again.');
...
/* eslint-disable */
mapboxgl.accessToken = 'pk.eyJ1IjoiaWdhdXJhdiIsImEiOiJjbDJzcGlrZmwwMTJlM2RrNDM4bGgyb2JzIn0.NvO9tWXOw9R8-7ADAxiIWg';
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; //adding the marker to the map

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //adding popup to the map

    new mapboxgl.Popup({
      closeOnClick: false,
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<h5>Day ".concat(loc.day, ": ").concat(loc.description, "</h5>")).addTo(map); //extends the map bounds to the current locations (zooming to locations)
...
var stripe = Stripe('pk_test_51KyyOZSDyhrWsx3IAJdeDcP0tpkxwXpBos71WE6aIUIJRHpbJ4nYwapJMXjUR79mH5AyGsPsasD8y83TepmPKqe000bGF56z2e');
...
var sendAlert = function sendAlert(res, type) {
  if (res.data.status === 'success') {
    (0, _alerts.showAlerts)('success', "".concat(type, " updated successfully!"));
    window.setTimeout(function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlerts)('error', _context.t0.response.data.message); // console.log(err);
...
var logoutbtn = document.querySelector('.nav__el--logout'); //////////////////////LOGIN FORM/////////////////////////////

var loginForm = document.querySelector('.form--login'); //values

var inputName = document.getElementById('name');
var inputEmail = document.getElementById('email'); //////////////////////USER-UPDATE FORM////////////////////////////////////

var formUserData = document.querySelector('.form-user-data'); // values

var email = document.getElementById('email');
var password = document.getElementById('password');
var photo = document.getElementById('photo'); ///////////////////////SECURITY FORM///////////////////////////////////

var securityForm = document.querySelector('.form-user-settings'); //values
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              e.preventDefault(); //beacuse sending file/image then do this
...
if (securityForm) {
  securityForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              passwordCurrent = curPassword.value;
